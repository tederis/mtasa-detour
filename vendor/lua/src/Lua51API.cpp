...
static struct
{
    ...
    VLUA_IMPORT_FN(int, lua_getstack) (lua_State *L, int level, Vlua_Debug *ar);
    VLUA_IMPORT_FN(int, lua_getinfo) (lua_State *L, const char *what, Vlua_Debug *ar);
    VLUA_IMPORT_FN(int, lua_sethook) (lua_State *L, Vlua_Hook func, int mask, int count);
...
bool VLua51_init()
{
    ...
    const static char* Vlua51_libname = VLUA_PLATFORM VLUA_LIB_PREFIX VLUA_LIB_NAME VLUA_LIB_SUFFIX VLUA_LIB_EXTENSION;
